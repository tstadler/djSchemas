...
class Cut(dj.Computed):
    ...
    def show_density(self,dens1,dens2,idx_thr1,idx_thr2):
        ...
        ax[0].set_xticks([0,idx_thr1,dens1.shape[0]])
        ax[0].set_xticklabels(['IPL',idx_thr1,'GCL'])
        ...
        ax[1].set_xticks([0,idx_thr2,dens2.shape[0]])
        ax[1].set_xticklabels(['IPL',idx_thr2,'GCL'])
